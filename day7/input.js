const input = `dull silver bags contain 2 striped magenta bags, 2 dark coral bags, 1 bright orange bag, 4 plaid blue bags.
...
bright chartreuse bags contain 2 wavy blue bags.`.split('\n')
